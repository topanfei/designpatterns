...
@Component
public class UserRegisterSendMailListener2 implements SmartApplicationListener{
	...
	public void onApplicationEvent(ApplicationEvent event) {
		...
		//给注册用户发送邮件通知
		System.out.println("demo4中：SmartApplicationListener方式。用户："+userBean.getName()+"，注册成功，发送邮件通知。");
